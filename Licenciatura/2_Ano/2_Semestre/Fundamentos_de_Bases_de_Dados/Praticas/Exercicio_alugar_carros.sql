...
create table alugueres_car (
	numero_aluguer_car int,
        matricula char(8),
        cod_cli_car char(10),
        cod_preco_car char(1),
        filial_saida char(1),
        filial_entrega char(1),
        euros_consumo decimal(6,1),
        euros_bandeirada decimal(5,2),
        data_aluguer_car date,
        data_devolucao_car date,
        kms_i int,
        kms_devolucao int,
        primary key (numero_aluguer_car)
